  ...
  if (allFrameHistory.size() == 2)
    ...
    for (float rotDelta = 0.02; rotDelta < 0.05; rotDelta++) {
      lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast *
                                 SE3(SO3::QuaternionMember(1, rotDelta, 0, 0),
                                     Vec3(0, 0, 0))); // assume constant motion.
      lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast *
                                 SE3(SO3::QuaternionMember(1, 0, rotDelta, 0),
                                     Vec3(0, 0, 0))); // assume constant motion.
      lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast *
                                 SE3(SO3::QuaternionMember(1, 0, 0, rotDelta),
                                     Vec3(0, 0, 0))); // assume constant motion.
      lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast *
                                 SE3(SO3::QuaternionMember(1, -rotDelta, 0, 0),
                                     Vec3(0, 0, 0))); // assume constant motion.
      ...
      lastF_2_fh_tries.push_back(
          ...
          SE3(SO3::QuaternionMember(1, rotDelta, rotDelta, 0),
              Vec3(0, 0, 0))); // assume constant motion.
      lastF_2_fh_tries.push_back(
          fh_2_slast.inverse() * lastF_2_slast *
          SE3(SO3::QuaternionMember(1, 0, rotDelta, rotDelta),
              Vec3(0, 0, 0))); // assume constant motion.
      lastF_2_fh_tries.push_back(
          fh_2_slast.inverse() * lastF_2_slast *
          SE3(SO3::QuaternionMember(1, rotDelta, 0, rotDelta),
              Vec3(0, 0, 0))); // assume constant motion.
      lastF_2_fh_tries.push_back(
          fh_2_slast.inverse() * lastF_2_slast *
          SE3(SO3::QuaternionMember(1, -rotDelta, rotDelta, 0),
      ...
      lastF_2_fh_tries.push_back(
          fh_2_slast.inverse() * lastF_2_slast *
          SE3(SO3::QuaternionMember(1, -rotDelta, -rotDelta, -rotDelta),
              Vec3(0, 0, 0))); // assume constant motion.
      lastF_2_fh_tries.push_back(
          fh_2_slast.inverse() * lastF_2_slast *
          SE3(SO3::QuaternionMember(1, -rotDelta, -rotDelta, rotDelta),
...
void FullSystem::activatePointsMT() {
  ...
  if (multiThreading)
    treadReduce.reduce(std::bind(&FullSystem::activatePointsMT_Reductor, this,
                                 &optimized, &toOptimize, std::placeholders::_1,
